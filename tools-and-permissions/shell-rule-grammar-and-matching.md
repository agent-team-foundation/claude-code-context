...
owners: []
soft_links: [/tools-and-permissions/permission-rule-loading-and-persistence.md, /tools-and-permissions/permission-decision-pipeline.md, /tools-and-permissions/control-plane-tools.md]
---
