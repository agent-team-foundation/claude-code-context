...
owners: []
soft_links: [/tools-and-permissions/agent-definition-loading-and-precedence.md, /tools-and-permissions/agent-tool-launch-routing.md, /collaboration-and-agents/worker-execution-boundaries.md, /integrations/mcp/mcp-surface-state-assembly-and-live-refresh.md, /integrations/plugins/plugin-and-skill-model.md]
---
...
- the longer-lived task registration, backgrounding, and notification lifecycle, already covered in [../runtime-orchestration/local-agent-task-lifecycle.md](../runtime-orchestration/local-agent-task-lifecycle.md)
