...
- **[companion-surface.md](companion-surface.md)** — How the hatched companion, command affordances, sprite layout, teaser notifications, and reaction bubbles stay synchronized with prompt and model behavior.
