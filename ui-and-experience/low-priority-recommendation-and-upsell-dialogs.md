...
owners: []
soft_links: [/collaboration-and-agents/repl-remote-control-lifecycle.md, /integrations/plugins/lsp-plugin-and-diagnostics.md, /integrations/plugins/plugin-management-and-marketplace-flows.md, /ui-and-experience/permission-prompt-shell-and-worker-states.md]
---
