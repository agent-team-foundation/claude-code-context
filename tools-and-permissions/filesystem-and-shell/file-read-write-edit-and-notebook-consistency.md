...
owners: []
soft_links: [/tools-and-permissions/filesystem-and-shell/path-and-filesystem-safety.md, /tools-and-permissions/execution-and-hooks/tool-execution-state-machine.md, /runtime-orchestration/sessions/file-checkpointing-and-rewind.md, /integrations/clients/ide-connectivity-and-diff-review.md, /integrations/plugins/skill-loading-contract.md]
---
