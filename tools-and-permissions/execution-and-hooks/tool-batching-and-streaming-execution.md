...
owners: []
soft_links: [/runtime-orchestration/turn-flow/query-loop.md, /tools-and-permissions/execution-and-hooks/tool-execution-state-machine.md, /runtime-orchestration/state/state-machines-and-failures.md]
---
