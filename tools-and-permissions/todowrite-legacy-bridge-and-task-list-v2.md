...
owners: []
soft_links: [/tools-and-permissions/task-and-team-control-tool-contracts.md, /runtime-orchestration/shared-task-list-contract.md, /ui-and-experience/background-task-status-surfaces.md, /collaboration-and-agents/team-formation-and-spawn-contract.md]
---
...
- deeper task-runtime visibility already covered in [../runtime-orchestration/shared-task-list-contract.md](../runtime-orchestration/shared-task-list-contract.md)
