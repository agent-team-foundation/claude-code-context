...
owners: []
soft_links: [/product-surface/interaction-modes.md, /product-surface/session-utility-commands.md, /runtime-orchestration/sessions/resume-path.md, /runtime-orchestration/sessions/session-reset-and-state-preservation.md, /runtime-orchestration/sessions/session-artifacts-and-sharing.md, /platform-services/interactive-startup-and-project-activation.md, /tools-and-permissions/agent-and-task-control/control-plane-tools.md, /tools-and-permissions/agent-and-task-control/agent-tool-launch-routing.md, /ui-and-experience/feedback-and-notifications/status-line-and-footer-notification-stack.md]
---
