...
owners: []
soft_links: [/runtime-orchestration/tasks/task-registry-and-visibility.md, /runtime-orchestration/sessions/session-reset-and-state-preservation.md, /tools-and-permissions/permissions/permission-mode-transitions-and-gates.md, /ui-and-experience/background-and-teamwork/background-task-status-surfaces.md, /ui-and-experience/background-and-teamwork/companion-surface.md]
---
