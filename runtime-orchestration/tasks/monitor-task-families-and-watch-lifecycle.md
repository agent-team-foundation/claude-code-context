...
owners: []
soft_links: [/runtime-orchestration/tasks/background-shell-task-lifecycle.md, /runtime-orchestration/tasks/task-model.md, /runtime-orchestration/tasks/task-registry-and-visibility.md, /runtime-orchestration/turn-flow/turn-attachments-and-sidechannels.md, /tools-and-permissions/filesystem-and-shell/shell-execution-and-backgrounding.md, /ui-and-experience/background-and-teamwork/background-task-status-surfaces.md, /ui-and-experience/background-and-teamwork/background-task-row-and-progress-semantics.md, /ui-and-experience/background-and-teamwork/background-task-detail-dialogs.md, /ui-and-experience/dialogs-and-approvals/permission-prompt-shell-and-worker-states.md]
---
