...
title: "Review Path"
owners: []
soft_links: [/product-surface/command-execution-archetypes.md, /collaboration-and-agents/remote-handoff-path.md, /tools-and-permissions/execution-and-hooks/tool-execution-state-machine.md]
---
