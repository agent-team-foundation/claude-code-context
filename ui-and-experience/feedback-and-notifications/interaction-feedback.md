...
owners: []
soft_links: [/tools-and-permissions/permissions/permission-model.md, /ui-and-experience/feedback-and-notifications/status-line-and-footer-notification-stack.md, /ui-and-experience/feedback-and-notifications/system-feedback-lines.md, /ui-and-experience/background-and-teamwork/background-task-status-surfaces.md, /ui-and-experience/dialogs-and-approvals/permission-prompt-shell-and-worker-states.md, /runtime-orchestration/turn-flow/query-loop.md]
---
