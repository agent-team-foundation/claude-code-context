...
title: "Query Loop"
owners: []
soft_links: [/runtime-orchestration/turn-assembly-and-recovery.md, /runtime-orchestration/unified-command-queue-and-drain.md, /memory-and-context/memory-layers.md, /tools-and-permissions/tool-families.md, /integrations/clients/sdk-control-protocol.md]
---
