...
owners: []
soft_links: [/tools-and-permissions/tool-families.md, /tools-and-permissions/permission-model.md, /tools-and-permissions/browser-automation-and-native-computer-use.md, /integrations/mcp/server-contract.md]
---
