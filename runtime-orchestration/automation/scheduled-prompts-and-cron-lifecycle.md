...
owners: []
soft_links: [/product-surface/command-surface.md, /runtime-orchestration/state/build-profiles.md, /tools-and-permissions/agent-and-task-control/control-plane-tools.md, /collaboration-and-agents/in-process-teammate-lifecycle.md, /ui-and-experience/feedback-and-notifications/system-feedback-lines.md]
---
...
- the generic system-message rendering rules already covered in [system-feedback-lines.md](../ui-and-experience/feedback-and-notifications/system-feedback-lines.md)
