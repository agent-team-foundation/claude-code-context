...
owners: []
soft_links: [/ui-and-experience/shell-and-input/prompt-composer-and-queued-command-shell.md, /ui-and-experience/feedback-and-notifications/system-feedback-lines.md, /memory-and-context/session-memory.md, /runtime-orchestration/state/app-state-and-input-routing.md]
---
