...
owners: []
soft_links: [/tools-and-permissions/tool-pool-assembly.md, /tools-and-permissions/tool-execution-state-machine.md, /runtime-orchestration/api-request-assembly-retry-and-prompt-cache-stability.md, /memory-and-context/compaction-execution-and-post-compact-rehydration.md, /integrations/mcp/config-layering-policy-and-dedup.md]
---
