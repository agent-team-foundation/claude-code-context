...
owners: []
soft_links: [/ui-and-experience/startup-and-onboarding/startup-welcome-dashboard-and-feed-rotation.md, /ui-and-experience/shell-and-input/terminal-setup-and-multiline-entry-affordances.md, /ui-and-experience/dialogs-and-approvals/focused-dialog-and-overlay-arbitration.md, /platform-services/interactive-startup-and-project-activation.md, /platform-services/workspace-trust-dialog-and-persistence.md, /platform-services/auth-login-logout-and-token-lifecycle.md]
---
