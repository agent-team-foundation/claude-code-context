...
owners: []
soft_links: [/runtime-orchestration/query-loop.md, /tools-and-permissions/permission-model.md, /ui-and-experience/feedback-state-machine.md]
---
...
- The runtime must emit typed lifecycle events rather than raw log text. Important event families include session start and end, tool execution, permission prompts and denials, subagent lifecycle, compaction, task lifecycle, worktree lifecycle, config changes, and file or instruction updates.
