...
owners: []
soft_links: [/tools-and-permissions/permissions/permission-model.md, /tools-and-permissions/permissions/permission-rule-loading-and-persistence.md, /tools-and-permissions/permissions/permission-decision-pipeline.md]
---
