...
owners: []
soft_links: [/ui-and-experience/dialogs-and-approvals/permission-prompt-shell-and-worker-states.md, /tools-and-permissions/permissions/permission-decision-pipeline.md, /runtime-orchestration/turn-flow/turn-attachments-and-sidechannels.md, /runtime-orchestration/automation/remote-planning-session-loop.md, /product-surface/session-state-and-breakpoints.md]
---
