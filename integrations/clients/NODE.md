...
- **[ccr-upstream-proxy-and-subprocess-egress.md](ccr-upstream-proxy-and-subprocess-egress.md)** — How CCR containers start a local CONNECT-over-WebSocket upstream relay, protect session tokens, provision a CA bundle, and inject proxy env into subprocesses without hijacking first-party API traffic.
...
- **[assistant-viewer-attach-and-history-paging.md](assistant-viewer-attach-and-history-paging.md)** — How a feature-gated persistent-assistant viewer surface discovers a running session, attaches as a viewer-skewed client, and pages remote history without taking over session ownership.
