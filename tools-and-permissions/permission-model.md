...
owners: []
soft_links: [/tools-and-permissions/permission-mode-transitions-and-gates.md, /tools-and-permissions/permission-decision-pipeline.md, /tools-and-permissions/permission-rule-loading-and-persistence.md, /tools-and-permissions/sandbox-selection-and-bypass-guards.md, /collaboration-and-agents/worker-execution-boundaries.md, /ui-and-experience/interaction-feedback.md, /platform-services/auth-config-and-policy.md]
---
