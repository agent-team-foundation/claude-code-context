...
owners: []
soft_links: [/integrations/plugins/skill-loading-contract.md, /product-surface/command-execution-archetypes.md, /tools-and-permissions/tool-catalog/tool-families.md]
---
