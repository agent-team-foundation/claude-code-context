...
owners: []
soft_links: [/product-surface/interaction-modes.md, /runtime-orchestration/turn-flow/unified-command-queue-and-drain.md, /tools-and-permissions/filesystem-and-shell/shell-execution-and-backgrounding.md, /memory-and-context/durable-memory-recall-and-auto-memory.md, /integrations/clients/remote-and-managed-client-envelopes.md]
---
