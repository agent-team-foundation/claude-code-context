...
owners: []
soft_links: [/ui-and-experience/permission-prompt-shell-and-worker-states.md, /ui-and-experience/plan-mode-approval-surfaces.md, /tools-and-permissions/permission-decision-pipeline.md, /tools-and-permissions/tool-families.md, /product-surface/session-state-and-breakpoints.md]
---
