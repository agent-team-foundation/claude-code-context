...
owners: []
soft_links: [/ui-and-experience/background-and-teamwork/background-task-detail-dialogs.md, /ui-and-experience/background-and-teamwork/background-task-row-and-progress-semantics.md, /runtime-orchestration/tasks/local-agent-task-lifecycle.md, /collaboration-and-agents/in-process-teammate-lifecycle.md]
---
