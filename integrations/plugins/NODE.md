...
- **[skill-search-and-canonical-skill-flow.md](skill-search-and-canonical-skill-flow.md)** — How feature-gated skill discovery, per-turn discovery reminders, session-scoped discovered names, and previously discovered remote canonical skills behave without collapsing into the ordinary local skill registry.
