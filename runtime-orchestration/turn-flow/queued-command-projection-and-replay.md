...
owners: []
soft_links: [/runtime-orchestration/turn-flow/unified-command-queue-and-drain.md, /runtime-orchestration/turn-flow/turn-attachments-and-sidechannels.md, /ui-and-experience/shell-and-input/prompt-composer-and-queued-command-shell.md, /collaboration-and-agents/bridge-session-state-projection-and-command-narrowing.md]
---
...
- prompt-buffer editing affordances already captured in [prompt-composer-and-queued-command-shell.md](../ui-and-experience/shell-and-input/prompt-composer-and-queued-command-shell.md)
