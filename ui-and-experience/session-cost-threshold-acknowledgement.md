...
owners: []
soft_links: [/platform-services/usage-analytics-and-migrations.md, /platform-services/auth-login-logout-and-token-lifecycle.md, /platform-services/claude-ai-limits-and-extra-usage-state.md, /ui-and-experience/status-line-and-footer-notification-stack.md]
---
